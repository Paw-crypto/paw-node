...
0xffffc00000000000, // 64x lower than publish_full.epoch_1
0xfffff80000000000, // same as epoch_1
0xfffe000000000000 // 2x lower than epoch_1
);
...
{
	auto test_env = get_env_or_default ("NANO_TEST_MAGIC_NUMBER", "PX");
